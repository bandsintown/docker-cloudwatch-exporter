...
# What is Cloudwatch exporter?

The cloudwatch-exporter is a Prometheus exporter to collect metrics from Cloudwatch.
...
We built this image to use Consul and Consul Template to be able to configure cloudwatch-exporter dynamically.
